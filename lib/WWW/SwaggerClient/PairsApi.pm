...
sub new {
    ...
    sub pairs_get {
      ...
      if ( exists $args{'cause_source'}) {
        $query_params->{'causeSource'} = WWW::::APIClient::to_query_value($args{'cause_source'});
      } # query params
      if ( exists $args{'cause_unit'}) {
        $query_params->{'causeUnit'} = WWW::::APIClient::to_query_value($args{'cause_unit'});
      } # query params
      if ( exists $args{'delay'}) {
        $query_params->{'delay'} = WWW::::APIClient::to_query_value($args{'delay'});
      } # query params
      if ( exists $args{'duration'}) {
        $query_params->{'duration'} = WWW::::APIClient::to_query_value($args{'duration'});
      } # query params
      if ( exists $args{'effect'}) {
        $query_params->{'effect'} = WWW::::APIClient::to_query_value($args{'effect'});
      } # query params
      if ( exists $args{'effect_source'}) {
        $query_params->{'effectSource'} = WWW::::APIClient::to_query_value($args{'effect_source'});
      } # query params
      if ( exists $args{'effect_unit'}) {
        $query_params->{'effectUnit'} = WWW::::APIClient::to_query_value($args{'effect_unit'});
      } # query params
