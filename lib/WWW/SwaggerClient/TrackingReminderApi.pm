...
#
package WWW::SwaggerClient::TrackingReminderApi;
...
# @param boolean $pop_up True if the reminders should appear as a popup notification (optional)
# @param boolean $sms True if the reminders should be delivered via SMS (optional)
# @param boolean $email True if the reminders should be delivered via email (optional)
# @param boolean $notification_bar True if the reminders should appear in the notification bar (optional)
...
# @param string $sort Sort by given field. If the field is prefixed with &#39;-&#39;, it will sort in descending order. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ tracking_reminders_get } = { 
...
#
sub tracking_reminders_get {
    my ($self, %args) = @_;

    

    # parse inputs
    my $_resource_path = '/trackingReminders';
    ...
    if ( exists $args{'pop_up'}) {
        $query_params->{'pop_up'} = $self->{api_client}->to_query_value($args{'pop_up'});
    }# query params
    if ( exists $args{'sms'}) {
        $query_params->{'sms'} = $self->{api_client}->to_query_value($args{'sms'});
    }# query params
    if ( exists $args{'email'}) {
        $query_params->{'email'} = $self->{api_client}->to_query_value($args{'email'});
    }# query params
    if ( exists $args{'notification_bar'}) {
        $query_params->{'notification_bar'} = $self->{api_client}->to_query_value($args{'notification_bar'});
    }# query params
    if ( exists $args{'last_reminded'}) {
        $query_params->{'last_reminded'} = $self->{api_client}->to_query_value($args{'last_reminded'});
    }# query params
    if ( exists $args{'last_tracked'}) {
        $query_params->{'last_tracked'} = $self->{api_client}->to_query_value($args{'last_tracked'});
    }# query params
...
# @param TrackingReminder $body TrackingReminder that should be stored (optional)
{
    ...
    __PACKAGE__->method_documentation->{ tracking_reminders_post } = { 
...
# @param string $access_token User&#39;s OAuth2 access token (optional)
{
    ...
    __PACKAGE__->method_documentation->{ tracking_reminders_id_get } = { 
...
# @return inline_response_200_23
#
sub tracking_reminders_id_get {
    my ($self, %args) = @_;

    
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling tracking_reminders_id_get");
    }
    

    # parse inputs
    my $_resource_path = '/trackingReminders/{id}';
    $_resource_path =~ s/{format}/json/; # default format to json
...
#
# tracking_reminders_id_put
#
# Update TrackingReminder
# 
# @param int $id id of TrackingReminder (required)
# @param string $access_token User&#39;s OAuth2 access token (optional)
# @param TrackingReminder $body TrackingReminder that should be updated (optional)
{
    my $params = {
    'id' => {
        data_type => 'int',
    ...
    __PACKAGE__->method_documentation->{ tracking_reminders_id_put } = { 
...
#
sub tracking_reminders_id_put {
    my ($self, %args) = @_;

    
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling tracking_reminders_id_put");
    }
...
# @param string $access_token User&#39;s OAuth2 access token (optional)
{
    ...
    __PACKAGE__->method_documentation->{ tracking_reminders_id_delete } = { 
...
# @return inline_response_200_2
#
sub tracking_reminders_id_delete {
    my ($self, %args) = @_;

    
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling tracking_reminders_id_delete");
    }
