...
has version_info => ( is => 'ro', 
                      isa => 'HashRef', 
                      default => sub { {
                          app_name => 'Quantimodo API',
                          app_version => '2.0',
                          generated_date => '2016-02-09T02:17:10.517Z',
...
WWW::SwaggerClient::Role - a Moose role for the Quantimodo API 

=head2 Quantimodo API version: 2.0
...
=item Build date: 2016-02-09T02:17:10.517Z
