...
# @param int $tag_variable_id This is the id of the ingredient variable whose value is determined based on the value of the tagged variable. (required)
{
    ...
    __PACKAGE__->method_documentation->{ v1_user_tags_delete_post } = { 
...
#
sub v1_user_tags_delete_post {
    my ($self, %args) = @_;

    # verify the required parameter 'tagged_variable_id' is set
    unless (exists $args{'tagged_variable_id'}) {
      croak("Missing the required parameter 'tagged_variable_id' when calling v1_user_tags_delete_post");
    }

    # verify the required parameter 'tag_variable_id' is set
    unless (exists $args{'tag_variable_id'}) {
      croak("Missing the required parameter 'tag_variable_id' when calling v1_user_tags_delete_post");
    }

    # parse inputs
    my $_resource_path = '/v1/userTags/delete';
    ...
    # query params
    if ( exists $args{'tagged_variable_id'}) {
        $query_params->{'taggedVariableId'} = $self->{api_client}->to_query_value($args{'tagged_variable_id'});
    }

    # query params
    if ( exists $args{'tag_variable_id'}) {
        $query_params->{'tagVariableId'} = $self->{api_client}->to_query_value($args{'tag_variable_id'});
    }
...
# @param string $access_token User&#39;s OAuth2 access token (optional)
{
    ...
    __PACKAGE__->method_documentation->{ v1_user_tags_post } = { 
...
# @return CommonResponse
#
sub v1_user_tags_post {
    my ($self, %args) = @_;

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling v1_user_tags_post");
    }

    # parse inputs
    my $_resource_path = '/v1/userTags';
    $_resource_path =~ s/{format}/json/; # default format to json
