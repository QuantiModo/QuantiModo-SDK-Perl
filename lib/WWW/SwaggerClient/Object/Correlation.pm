...
__PACKAGE__->method_documentation({
    'correlation_coefficient' => {
    	datatype => 'Number',
    	base_name => 'correlationCoefficient',
    ...
    'statistical_significance' => {
    	datatype => 'string',
    	base_name => 'statisticalSignificance',
    ...
    'value_predicting_high_outcome' => {
    	datatype => 'Number',
    	base_name => 'valuePredictingHighOutcome',
    ...
    'value_predicting_low_outcome' => {
    	datatype => 'Number',
    	base_name => 'valuePredictingLowOutcome',
    ...
    'optimal_pearson_product' => {
    	datatype => 'Number',
    	base_name => 'optimalPearsonProduct',
