...
#
package WWW::SwaggerClient::Object::TrackingReminderNotification;
...
__PACKAGE__->method_documentation({
    ...
    'pending_reminder_time' => {
    	datatype => 'DateTime',
    	base_name => 'pendingReminderTime',
    	description => 'ISO 8601 timestamp for the specific time the variable should be tracked in UTC.  This will be used for the measurement startTime if the track endpoint is used.',
    	format => '',
    	read_only => '',
    		},
    'default_value' => {
